...
function renderMarkdown(text) {
  ...
  html = html.replace(
    /\[CONV:(\d+)\]/g,
    '<a class="conv-link" data-conv-id="$1" style="color:#38bdf8;cursor:pointer;text-decoration:none;font-family:monospace;font-size:12px;background:rgba(56,189,248,0.08);padding:2px 6px;border-radius:4px;transition:all 0.15s">[CONV:$1]</a>'
  );
