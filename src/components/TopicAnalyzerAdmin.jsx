      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginTop: '1rem' }}>
          ...
          <button onClick={handleAnalyzeUnanalyzed} disabled={isProcessing} title="Run AI topic & sentiment analysis on CFD/Futures conversations with Transcript but empty Sub-Topics"
            style={{ padding: '0.75rem 1.5rem', borderRadius: '8px', border: 'none', background: isProcessing ? 'rgba(55, 65, 81, 0.8)' : 'linear-gradient(135deg, #7C3AED, #6366F1)', color: '#fff', fontSize: '0.875rem', fontWeight: '600', cursor: isProcessing ? 'not-allowed' : 'pointer' }}>
            ...
            {(isAnalyzing || progress.analyzed > 0) && (
              <>
                <div>
                  ...
                  <div style={{ color: '#38BDF8', fontSize: '1.5rem', fontWeight: '700' }}>{progress.toAnalyze.toLocaleString()}</div>
                </div>
                <div>
      ...
      <div style={{ background: 'rgba(30, 41, 59, 0.4)', borderRadius: '12px', padding: '1.5rem', marginBottom: '1.5rem', border: '1px solid rgba(56, 189, 248, 0.2)' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap', marginTop: '1rem' }}>
          ...
          <button onClick={handleSyncFIN} disabled={isProcessing}
            style={{ padding: '0.75rem 1.5rem', borderRadius: '8px', border: 'none', background: isProcessing ? 'rgba(55,65,81,0.8)' : 'linear-gradient(135deg, #0EA5E9, #38BDF8)', color: '#fff', fontSize: '0.875rem', fontWeight: '600', cursor: isProcessing ? 'not-allowed' : 'pointer', alignSelf: 'flex-end' }}>
