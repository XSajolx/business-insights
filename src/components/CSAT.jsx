                                        ...
                                        {DRILL_COLUMNS.map(col => (
                                            <td key={col.key} style={{
                                                ...
                                                color: col.key === 'Conversation rating'
                                                    ...
                                                    : col.key === 'Conversation ID' ? '#58A6FF' : '#C9D1D9',
...
const CSAT = () => {
    ...
    return (
        <div className="cex-csat" style={{ opacity: loading ? 0.6 : 1, transition: 'opacity 0.2s' }}>
            ...
            {/* Drill-in Modal */}
            <DrillInModal drillIn={drillIn} onClose={closeDrillIn} onAskAthena={(title, count, items) => athena.openAthenaForContext(title, 'csat-drill', title, '#6366F1', count, items)} />
