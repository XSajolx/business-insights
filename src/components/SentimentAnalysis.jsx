                                            ...
                                            <td style={{ padding: '10px 8px', maxWidth: '120px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                                {row.conversation_id ? (
                                                    <span
                                                        ...
                                                        style={{
                                                            color: '#58A6FF', fontFamily: 'monospace', fontSize: '0.75rem',
                ...
                >
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <div style={{ color: '#58A6FF', fontFamily: 'monospace', fontSize: '0.85rem', marginTop: '2px' }}>{viewingConv.id}</div>
                        </div>
                        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                            <a
                                ...
                                return (
                                    <div key={idx} style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{ fontSize: '0.65rem', fontWeight: '700', marginBottom: '4px', color: isAgent ? '#818CF8' : '#58A6FF', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        ...
        <div style={{ padding: '0 2rem 2rem 2rem' }}>
            ...
            {showDrillIn && (
                <ConversationList
                    ...
                    mode="sentiment"
                    onAskAthena={(title, count, items) => athena.openAthenaForContext(title, 'sentiment-drill', title, '#6366F1', count, items)}
                />
            )}

            {/* Icon-triggered DrillInModal */}
            <DrillInModal drillIn={drillIn} onClose={() => setDrillIn(null)} onAskAthena={(title, count, items) => athena.openAthenaForContext(title, 'sentiment-drill', title, '#6366F1', count, items)} />
