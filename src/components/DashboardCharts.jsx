...
const QUERY_COLOR_MAP = {
    ...
    'CHALLENGE SELECTION QUERY': '#58A6FF',
...
const FALLBACK_COLORS = [
    '#58A6FF', '#F778BA', '#3FB950', '#F0883E', '#A371F7',
                                                    ...
                                                    <BarChart data={barData} layout="vertical" margin={{ top: 5, right: 50, left: 10, bottom: 0 }} barCategoryGap="20%">
                                                        ...
                                                        <Bar dataKey="value" radius={[0, 4, 4, 0]} barSize={22} onClick={(data) => handleMainTopicDrillIn(data.name)} style={{ cursor: 'pointer' }}>
                                                            {barData.map((entry, index) => (
                                                                <Cell key={`cell-${index}`} fill={subTab === 'issue' ? entry.color : '#2563EB'} style={{ cursor: 'pointer' }} />
                                                            ))}
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            ...
                            >
                                ...
                                <Area
                                    ...
                                    dot={{ r: 4, fill: '#38BDF8', stroke: '#0D1117', strokeWidth: 2, cursor: 'pointer' }}
                                    activeDot={{
                                        r: 7,
                                        fill: '#38BDF8',
                                        stroke: '#0D1117',
                                ...
                                >
                                    <LabelList dataKey="Current" position="top" fill="#38BDF8" fontSize={11} fontWeight={600} offset={8} />
                                </Area>
                            </AreaChart>
                        </ResponsiveContainer>
                    ) : (
