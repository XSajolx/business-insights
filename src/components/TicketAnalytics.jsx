    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          width: `${clamped}%`, background: '#6366F1', borderRadius: '3px'
        }} />
      </div>
    </div>
  );
...
const TicketAnalytics = ({ dateRange }) => {
  ...
  const productTypeData = useMemo(() => {
    ...
    const COLORS = { 'CFD': '#6366F1', 'Futures': '#22D3EE', 'Unknown': '#6B7280' };
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 8, padding: '0.3rem 0.7rem', color: '#6366F1', fontSize: '0.72rem',
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px', flexWrap: 'wrap' }}>
            ...
            <span style={{ fontSize: 11, color: '#64748B' }}>
              {heatmapData.total.toLocaleString()} tickets · peak hour: <strong style={{ color: '#38BDF8' }}>{heatmapData.max}</strong>
            </span>
          </div>
                    ...
                    <td style={{ ...tdStyle, fontSize: '0.75rem' }}>
                      {d.ticket_id !== '-' ? (
                        <span
                          ...
                          style={{ color: '#58A6FF', fontFamily: 'monospace', cursor: 'pointer' }}
                          onMouseEnter={e => { e.currentTarget.style.textDecoration = 'underline'; }}
                          onMouseLeave={e => { e.currentTarget.style.textDecoration = 'none'; }}
                          title="Click to view ticket conversation"
                        >
