                                ...
                                {pageData.map((row, i) => {
                                    ...
                                    return (
                                        <tr key={i} style={{
                                            ...
                                            <td
                                                style={{ padding: '9px 14px', color: '#58A6FF', fontFamily: 'monospace', fontSize: '0.75rem', whiteSpace: 'nowrap', cursor: row.conversation_id ? 'pointer' : 'default' }}
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 1.25rem', borderBottom: '1px solid #30363D' }}>
                        <div>
                            ...
                            <span style={{ color: '#58A6FF', fontFamily: 'monospace', fontSize: '0.75rem' }}>{viewingConv.id}</span>
                        </div>
                        <div style={{ display: 'flex', gap: 8 }}>
                            <button onClick={() => window.open(`https://app.intercom.com/a/apps/aphmhtyj/inbox/inbox/conversation/${viewingConv.id}`, '_blank')}
                                style={{ background: 'rgba(56,189,248,0.12)', border: '1px solid rgba(56,189,248,0.2)', color: '#38BDF8', borderRadius: 6, padding: '4px 10px', fontSize: '0.7rem', cursor: 'pointer', fontWeight: 500 }}>
                                Open in Intercom ↗
                            </button>
