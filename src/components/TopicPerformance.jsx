...
const TopicPerformance = ({ filters = {} }) => {
    ...
    const METRICS = [
        { key: 'art', label: 'Avg Response Time', color: '#38BDF8', formatter: fmtTime, ref: null },
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                <KpiCard label="Avg Response Time (ART)" value={fmtTime(kpis.art)} sub="across all topics" color="#38BDF8" />
                                    ...
                                    .map(([topic, v], i) => {
                                        ...
                                        return (
                                            <tr key={topic} style={{ borderBottom: '1px solid rgba(48,54,61,0.6)', background: i % 2 === 0 ? 'transparent' : 'rgba(28,33,40,0.4)' }}>
                                                ...
                                                <td style={{ padding: '9px 14px', color: '#38BDF8' }}>{fmtTime(artAvg)}</td>
