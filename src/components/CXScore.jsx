...
const KpiCard = ({ label, value, sub, color = '#6366F1', locked }) => (
    <div style={{
    ...
    return (
        <div style={{ padding: '0 0 2rem' }}>
            ...
            <div style={{
                ...
                border: '1px solid rgba(255,255,255,0.06)', borderLeft: '3px solid #6366F1',
                ...
                <Card title="CX Score Trend Over Time" subtitle="Daily average CX Score" fullWidth={false}>
                    <ResponsiveContainer width="100%" height={220}>
                        <AreaChart data={cxTrend} margin={{ top: 8, right: 12, left: -20, bottom: 0 }}>
                            ...
                            <Area type="monotone" dataKey="cx" name="CX Score" stroke="#6366F1" strokeWidth={2} fill="url(#cxGrad)" dot={false} />
                        </AreaChart>
                    </ResponsiveContainer>
                </Card>
                ...
                <Card title="CX Score vs CSAT Comparison" subtitle="Daily averages — CX Score (purple) vs CSAT (teal)">
                    <ResponsiveContainer width="100%" height={220}>
                        <LineChart data={comparisonData} margin={{ top: 8, right: 12, left: -20, bottom: 0 }}>
                            ...
                            <Line type="monotone" dataKey="cx" name="CX Score" stroke="#6366F1" strokeWidth={2} dot={false} />
